...
To separate code that we want to run directly from code that we only want to import, we should use the if \_\_name\_\_ == "\_\_main\_\_": idiom in Python. This is a common pattern that allows a Python script to be both importable and executable. Here's an explanation:

1. When a Python file is run directly, Python sets the special \_\_name\_\_ variable to "\_\_main\_\_".
2. When a Python file is imported as a module, \_\_name\_\_ is set to the name of the module.
