...
- This is single-step builder. Should we split it to `dependencies` and `runtime` steps. [further reading, ["A perfect way to Dockerize your Pipenv Python application"](https://sourcery.ai/blog/python-docker/)]{.aside}
