...
- **base**: bạn có thể tạo (gen) hoặc hấp thụ lực (absord) nhờ vai và vị trí đặt chân.
...
- mỗi chi bạn đều có 3 khớp (joints) chính: với tay là vai (shoulders), khuỷu tay (elbows), cổ tay (wrist), với chân là hông (hip), đầu gối (knee), và cổ chân (ankles);
...
- khi không ai có ưu thế, người đầu tiên kiểm soát được lever của đối phương sẽ kiểm soát trấn đấu; [đọc thêm về [grips dictate position](https://bjjmentalmodels.com/grips-dictate-position/)]{.aside}
...
ngược lại, nên hạn chế tấn công vào core của đối thủ. sẽ dễ dàng hơn khi tấn công vào 4 góc phần tư của cơ thể (torso) họ - là 4 chi (limbs) và tất nhiên bao gồm hai bên hông và hai vai. kiểm soát levers tạo ra leverages, và rất dễ phá vỡ được alignment của đối thủ hơn.
...
2. **prevent predictable defenses**: dự đoán các cách phòng thủ của đối thủ và đưa ra biện pháp phòng ngừa, cùng nên tập cải thiện alignment của bản thân trước khi phá vỡ alignment của họ;
3. **maximize leverage**: 
...
4. **compression chokes**: ép phổi làm đối phương khó chịu vì không đưa không khí vào phổi được, ví dụ như body triangle hay [Bas Rutten body crush](https://www.youtube.com/watch?v=baiTE16e5xE). nó cũng có thể làm gãy xương sườn và có thể không hợp lệ trong một số bộ quy tắc;
...
- khi kéo đầu đối phương xuống, hay kéo và vặn/xoắn cổ.
