...
khi bung sức, cần sử dụng cả core và nhiều chi nhất có thể, hãy nhớ chỉ sau khi tận dụng tối đa các ưu thế kĩ thuật (technical leverages), bạn mới bung sức. [xem thêm [overwhelming force](https://www.bjjmentalmodels.com/overwhelming-force/)]{.aside}

# 6. [choking mechanics](https://bjjmentalmodels.com/choking-mechanics/)

có năm loại siết nghẹt:

1. air chokes: tạo áp lực lên khí quản (trachea/windpipe) để ngăn cản đối phương hô hấp, thở. nó cũng có thể được hiệu chỉnh để tạo ra phản xạ hầu / phản xạ họng, [xem thêm [gax reflex](https://en.wikipedia.org/wiki/Pharyngeal_reflex)]{.aside} tạo ra hiệu ứng như blood choke;
2. blood chokes;
3. cranks;
...
# 14. [ody tethering](https://bjjmentalmodels.com/body-tethering/)
