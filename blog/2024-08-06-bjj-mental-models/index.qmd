...
kẹp thường được sử dụng khi bạn đã khóa (lock) được một phần cơ thể của đối thủ trong một vòng khép kín (**closed circuit**), siết chặt hai tay và hai chân để tạo ra một chuối động lực học. [xem thêm [kinetic chains](https://bjjmentalmodels.com/kinetic-chains/)]{.aside}
...
hook nhìn chung cũng yếu, bởi vì bạn kiểm soát từ bên trong (không phải bên ngoài và tạo một vòng **khép kín**). nó sẽ bị vô hiệu hóa nếu đối phương luồn tay thoát vị trí (pummels) hoặc thoát ly, gỡ khóa (disengages).
