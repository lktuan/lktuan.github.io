...
description: "Đây là các ghi chú của mình sau các buổi training Brazilian Jiu Jitsu tại [Sói Jiu Jitsu](https://www.facebook.com/soibjj). Ghi chú này không **hoàn toàn** phản ánh kiến thức được giảng dạy - một cách đúng đắn và đầy đủ - vì lẽ:<br>
<br>
...
::: {.callout-note title="Deep half" collapse="true"}
...
::: {.callout-note title="Put constant pressure on your opponent" collapse="true"}
> Ta phải đánh đổi giữa sự linh hoạt (flexibility) của bản thân và áp lực (pressure) lên người đối thủ.

Hôm nay tập hand figting và làm quen kiểm soát tay từ butterfly guard (bottom), hai thứ quan trọng cần nhớ vẫn là:
...
::: {.callout-note title="Some details to focus" collapse="true"}
...
::: {.callout-note title="Distance control and matter of inside or outside" collapse="true"}
Khẩu quyết đầu ngày:
